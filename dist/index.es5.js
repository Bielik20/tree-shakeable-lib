...
function first() {
  ...
  console.log('this is from first', __assign({}, o, {
    c: 'c'
  }));
}
...
_includesInstanceProperty(_context = 'abc').call(_context, 'b');

export { DummyClass, ProductsClass, dummy, engine, first, products, promise, second, third };
